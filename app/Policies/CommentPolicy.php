...
class CommentPolicy
{
     ...
     */
    public function forceDelete(User $authenticatedUser, PostComment $comment): bool
    {
        return $authenticatedUser->id === $comment->post->user['id'] || $authenticatedUser->id === $comment->user['id'] || $authenticatedUser->role['type'] === 'Moderator' || $authenticatedUser->role['type'] === 'Administrator';
    }
}
